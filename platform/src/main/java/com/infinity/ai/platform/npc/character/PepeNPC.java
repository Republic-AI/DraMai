...
//农夫NPC
public class PepeNPC extends NPC {

    public PepeNPC(Long id, String name) {
        super(id, name);
    }
    ...
    protected void registAction() {
        ...
        this.addAction(new StockAction(null));
        this.addAction(new TidyUpAction(List.of(new StockAction(null, List.of("pepeGetItem")))));
        this.addAction(new CookAction(null));
        this.addAction(new DinningAction(List.of(new CookAction(null, List.of("pepeCook")))));
        this.addAction(new SaleAction(null, List.of("pepeSale")));
