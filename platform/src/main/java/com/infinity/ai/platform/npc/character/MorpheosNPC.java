...
//农夫NPC
public class MorpheosNPC extends NPC {

    public MorpheosNPC(Long id, String name) {
        super(id, name);
    }
        ...
        if (todo.isEmpty() && current == 0) {
            ...
            if (oid.equals("moveTo")) {
               ...
               // doAction(ActionEnumType.Move.getCode(), params);
                ...
                } else if (oid.equals("morpheosDricoffee")) {
                    actionId = ActionEnumType.DrinkCoffee.getCode();
                } else if (oid.equals("morpheosTree")) {
                    actionId = ActionEnumType.ChristmasTree.getCode();
                } else if (oid.equals("morpheosDraw")) {
