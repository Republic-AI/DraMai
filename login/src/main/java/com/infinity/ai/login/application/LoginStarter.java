...
import com.infinity.ai.login.LoginService;
...
@Slf4j
public final class LoginStarter implements IGameStarter {
    private ApplicationContext context = null;
    private static LoginStarter kInstance = null;
    ...
    public static LoginStarter getInstance() {
        if (kInstance == null)
            kInstance = new LoginStarter();
        return kInstance;
    }
    ...
    public final void start() {
        log.info(LoginService.class.toString());
        log.info("=========================================================");
