...
import com.infinity.ai.login.task.chat.ChatTask;
import com.infinity.ai.login.task.chat.QueryChatTask;
import com.infinity.ai.login.task.system.RefreshTask;
import com.infinity.ai.login.task.user.LogoutTask;
import com.infinity.ai.login.task.user.RefreshGameUserTask;
