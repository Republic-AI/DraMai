...
import com.infinity.ai.login.HallService;
...
@Slf4j
public final class HallStarter implements IGameStarter {
    private ApplicationContext context = null;
    private static HallStarter kInstance = null;
    ...
    public static HallStarter getInstance() {
        if (kInstance == null)
            kInstance = new HallStarter();
        return kInstance;
    }
    ...
    public final void start() {
        log.info(HallService.class.toString());
        log.info("=========================================================");
