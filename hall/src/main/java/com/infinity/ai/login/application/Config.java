...
public class Config {
    ...
    private void readServiceConfig() {
        ...
        nodeId = properties.getProperty("service.login.id");
        type = properties.getProperty("service.login.type");
        ip = properties.getProperty("service.login.ip");
        port = Integer.parseInt(properties.getProperty("service.login.port"));
        maxChannel = Integer.parseInt(properties.getProperty("service.login.maxChannel"));
