...
import { AStar } from "../NPC/AStar";
import { NpcManager } from "../NPC/NpcManager";
import { numScrollNode } from "../../resources/tileModel/SatoshiMap/script/numScrollNode";
//import { fixPrefab } from "../../resources/tileModel/SatoshiMap/script/fixPrefab";
import { AudioManager } from "../manager/AudioManager";
import { UILayer } from "../game/gameUI/UILayer";
import { GameScene } from "../game/scene/GameScene";
import { PlayerManager } from "../NPC/PlayerManager";
import { nftPrefab } from "./nftPrefab";
import { changeSkinPrefab } from "../game/gameUI/changeSkinPrefab";
...
@ccclass('zhongbencongLayer')
export class zhongbencongLayer extends Component {
    @property({ type: [Node] })
    ...
    @property(Node)
    scrollNumNode: Node = null;

    @property(Node)
    scrollNumNode_2: Node = null;

    @property(Node)
    typeComputerNode: Node = null;

    @property(Node)
    fixNode: Node = null;

    @property(Prefab)
    fixPrefab: Prefab = null;

    @property(Node)
    typeBotNode: Node = null;
    ...
    @property(Node)
    morpheusCoffeeNode:Node = null;

    @property(Node)
    avaFoodNode:Node = null;

    @property(Node)
    avaCoffeeNode:Node = null;

    @property(Node)
    avaComputerEffect:Node = null;

    @property(Node)
    lunaFoodNode:Node = null;
    ...
    _initData() {
        ...
        for(let i = 1 ; i <=12; i++){
            this._typeComputerInfo[i] = {};
            this._typeComputerInfo[i]["node"] = find("typeComputer_" +i,this.node.getChildByName("bg_15"));
            this._typeComputerInfo[i]["node"].active = false;
            this._typeComputerInfo[i]["status"] = "off";
            this._typeComputerInfo[i]["botNum"] = 0;
            this._typeComputerInfo[i]["node"].children[0].active = false;
        }
