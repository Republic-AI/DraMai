...
@ccclass('gameLayer_map4')
export class gameLayer_map4 extends Component {
    @property({ type: [Node] })
        ...
        try {
            ...
            if (actionData.actionId === NpcEventType.move) {
                ...
                if(actionData.npcId == 10016){
                    this.leoFoodNode.active = false;
                }
                else if(actionData.npcId == 10017){
                    this.ivyFoodNode.active = false;
                }
                ...
                else if(actionData.npcId == 10016){
                    npcControl.setIdleStatus(KeyCode.KEY_W);
                }
                ...
                if(actionData.npcId == 10016){
                    this.leoFoodNode.active = true;
                    this.leoFoodNode.children[0].active = true;
                    this.leoFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_D);
                }
                else if(actionData.npcId == 10017){
                    this.ivyFoodNode.active = true;
                    this.ivyFoodNode.children[0].active = true;
                    this.ivyFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_D);
                }
                else if(actionData.npcId == 10018){
                    this.kaiFoodNode.active = true;
                    this.kaiFoodNode.children[0].active = true;
                    this.kaiFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_S);
                }
                else if(actionData.npcId == 10019){
                    this.selenaFoodNode.active = true;
                    this.selenaFoodNode.children[0].active = true;
                    this.selenaFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_D);
                }
                else if(actionData.npcId == 10020){
                    this.novaFoodNode.active = true;
                    this.novaFoodNode.children[0].active = true;
                    this.novaFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_S);
                }
                else if(actionData.npcId == 10021){
                    this.aidenFoodNode.active = true;
                    this.aidenFoodNode.children[0].active = true;
                    this.aidenFoodNode.children[1].active = false;
                    npcControl.setIdleStatus(KeyCode.KEY_D);
                }
                ...
                tween(this.node).delay(5).call(()=>{
                    if(actionData.npcId == 10016){
                        this.leoFoodNode.active = true;
                        this.leoFoodNode.children[0].active = false;
                        this.leoFoodNode.children[1].active = true;
                    }
                    else if(actionData.npcId == 10017){
                        this.ivyFoodNode.active = true;
                        this.ivyFoodNode.children[0].active = false;
                        this.ivyFoodNode.children[1].active = true;
                    }
                    else if(actionData.npcId == 10018){
                        this.kaiFoodNode.active = true;
                        this.kaiFoodNode.children[0].active = false;
                        this.kaiFoodNode.children[1].active = true;
                    }
                    else if(actionData.npcId == 10019){
                        this.selenaFoodNode.active = true;
                        this.selenaFoodNode.children[0].active = false;
                        this.selenaFoodNode.children[1].active = true;
                    }
                    else if(actionData.npcId == 10020){
                        this.novaFoodNode.active = true;
                        this.novaFoodNode.children[0].active = false;
                        this.novaFoodNode.children[1].active = true;
                    }
                    else if(actionData.npcId == 10021){
                        this.aidenFoodNode.active = true;
                        this.aidenFoodNode.children[0].active = false;
                        this.aidenFoodNode.children[1].active = true;
                    }
                }).start();
                ...
                this._initActionData[NPC.id].forEach(data=>{
                    if(data.actionId == NpcEventType.move && data.params.path.length > 0){
                        ...
                        if(NPC.id == 10008){
                            ...
                            // this.pepeCoffeeNode.active = false;
                        }
                        else if(NPC.id == 10007){
                            // this.catFoodNode.active = false;
                            // this.popcatCoffeeNode.active = false;
